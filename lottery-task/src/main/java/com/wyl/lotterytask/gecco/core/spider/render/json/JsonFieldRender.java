...
import com.wyl.lotterytask.gecco.core.annotation.JSONPath;
...
public class JsonFieldRender implements FieldRender {
	...
	private Object injectJsonField(HttpRequest request, Field field, Object json) {
		JSONPath JSONPath = field.getAnnotation(com.wyl.lotterytask.gecco.core.annotation.JSONPath.class);
