...
import com.wyl.lotterydatasource.dynamic.DatasourceChangeAspect;
import com.wyl.lotterydatasource.dynamic.DynamicDatasource;
...
@ConditionalOnProperty(prefix = "wyl.dynamic.datasource", name = "enable")
